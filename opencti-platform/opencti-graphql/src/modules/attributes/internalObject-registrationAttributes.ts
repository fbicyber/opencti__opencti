...
const ContextDataDefinition: AttributeDefinition = {
  name: 'context_data',
  label: 'Context data',
  type: 'object',
  format: 'standard',
...
const UserDefinition: AttributeDefinition[] = [
...
const internalObjectsAttributes: { [k: string]: Array<AttributeDefinition> } = {
  ...
  [ENTITY_TYPE_USER]: UserDefinition,
  [ENTITY_TYPE_ROLE]: [
    { name: 'name', label: 'Name', type: 'string', format: 'short', mandatoryType: 'external', editDefault: true, multiple: false, upsert: false, isFilterable: true },
    { name: 'description', label: 'Description', type: 'string', format: 'text', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, isFilterable: true },
  ...
  [ENTITY_TYPE_SEARCH]: [
    ContextDataDefinition,
    {
      ...
      upsert: false,
      isFilterable: true,
      mappings: UserDefinition,
    },
    { name: 'result_count', label: 'Result Count', type: 'numeric', precision: 'integer', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, isFilterable: false },
  ],
