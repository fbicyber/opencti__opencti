...
export const stixCoreRelationshipsMapping: RelationshipMappings = {
  ...
  [`${ENTITY_TYPE_IDENTITY_SYSTEM}_${ENTITY_SOFTWARE}`]: [
  ...
  [`${ENTITY_HASHED_OBSERVABLE_ARTIFACT}_${ENTITY_HASHED_OBSERVABLE_ARTIFACT}`]: [
    { name: RELATION_INTERPRETED_BY, type: REL_EXTENDED },
    { name: RELATION_DERIVED_FROM, type: REL_BUILT_IN },
  ],
  ...
  // region CITIZENSHIP_DOCUMENT
  [`${ENTITY_TYPE_IDENTITY_CITIZENSHIP_DOCUMENT}_${ENTITY_TYPE_LOCATION_ADMINISTRATIVE_AREA}`]: [
    { name: RELATION_LOCATED_AT, type: REL_EXTENDED },
    { name: RELATION_ORIGINATES_FROM, type: REL_EXTENDED },
  ],
  ...
  [`${ENTITY_TYPE_IDENTITY_CITIZENSHIP_DOCUMENT}_${ENTITY_TYPE_LOCATION_REGION}`]: [
    { name: RELATION_LOCATED_AT, type: REL_EXTENDED },
  ],
  [`${ENTITY_TYPE_IDENTITY_CITIZENSHIP_DOCUMENT}_${ENTITY_TYPE_LOCATION_POSITION}`]: [
    { name: RELATION_LOCATED_AT, type: REL_EXTENDED },
  ],
