const i18n = {
  messages: {
    'es-es': {
      ...
      'The first photo is the primary photo': 'La primera foto es la foto principal.',
      'Move photo up': 'Mover foto arriba',
      'Move photo down': 'Mover foto hacia abajo',
      'Photo Data': 'Datos de la foto',
      'Information about the photos in the carousel.': 'Información sobre las fotos en el carrusel.',
      'Photo Carousel': 'Carrusel de fotos',
      'Enriching photos of the Threat Actor.': 'Fotos enriquecedoras del Actor Amenaza.',
      'Add a profile photo with comments': 'Añadir una foto de perfil con comentarios',
      'Toggle editing off': 'Desactivar la edición',
      'Toggle editing on': 'Activar la edición',
      'No known photos of entity have been uploaded': 'No se han subido fotos conocidas de la entidad.',
      'No Comments on Photo': 'No hay comentarios en la foto',
      // Form
      Yes: 'Sí',
      No: 'No',
      ...
      File: 'Fichero',
      'Photo Comment': 'Comentario de foto',
      'Select a file to upload and provide a comment to describe it.': 'Seleccione un archivo para cargar y proporcione un comentario para describirlo.',
      // Menu
    ...
    'fr-fr': {
      ...
      'The first photo is the primary photo': 'La première photo est la photo principale',
      'Move photo up': 'Déplacer la photo vers le haut',
      'Move photo down': 'Déplacer la photo vers le bas',
      'Photo Data': 'Datos de la foto',
      'Information about the photos in the carousel.': 'Informations sur les photos dans le carrousel.',
      'Photo Carousel': 'Carrousel de photos',
      'Enriching photos of the Threat Actor.': 'Photos enrichissantes de l\'acteur de la menace.',
      'Add a profile photo with comments': 'Ajouter une photo de profil avec des commentaires',
      'Toggle editing off': 'Désactiver l\'édition',
      'Toggle editing on': 'Activer l\'édition',
      'No known photos of entity have been uploaded': 'Aucune photo connue de l\'entité n\'a été téléchargée',
      'No Comments on Photo': 'Aucun commentaire sur la photo',
      // Form
      Yes: 'Oui',
      No: 'Non',
      ...
      File: 'Déposer',
      'Photo Comment': 'Commentaire photo',
      'Select a file to upload and provide a comment to describe it.': 'Sélectionnez un fichier à télécharger et fournissez un commentaire pour le décrire.',
      // Menu
    ...
    'ja-jp': {
      ...
      'The first photo is the primary photo': '最初の写真がメインの写真です',
      'Move photo up': '写真を上に移動',
      'Move photo down': '写真を下に移動',
      'Photo Data': '写真データ',
      'Information about the photos in the carousel.': 'カルーセル内の写真に関する情報。',
      'Photo Carousel': '写真カルーセル',
      'Enriching photos of the Threat Actor.': '脅威アクターの充実した写真。',
      'Add a profile photo with comments': 'コメント付きのプロフィール写真を追加する',
      'Toggle editing off': '編集をオフに切り替えます',
      'Toggle editing on': '編集をオンに切り替えます',
      'No known photos of entity have been uploaded': '実体の既知の写真がアップロードされていません',
      'No Comments on Photo': '写真へのコメントはありません',
      // Form
      Yes: 'はい',
      No: 'いいえ',
      ...
      File: 'ファイル',
      'Photo Comment': '写真コメント',
      'Select a file to upload and provide a comment to describe it.': 'アップロードするファイルを選択し、それを説明するコメントを入力します。',
      // Menu
      Dashboard: 'ダッシュボード',
      Visualization: '可視化',
      Workspaces: 'ワークスペース',
    ...
    'zh-cn': {
      ...
      'are updating...': '正在更新...',
      'is updating...': '正在更新...',
      'The first photo is the primary photo': '第一张照片是主照片',
      'Move photo up': '将照片向上移动',
      'Move photo down': '将照片向下移动',
      'Photo Data': '照片数据',
      'Information about the photos in the carousel.': '有关轮播中照片的信息。',
      'Photo Carousel': '照片轮播',
      'Enriching photos of the Threat Actor.': '丰富威胁行为者的照片。',
      'Add a profile photo with comments': '添加带有评论的个人资料照片',
      'Toggle editing off': '关闭编辑',
      'Toggle editing on': '开启编辑',
      'No known photos of entity have been uploaded': '尚未上传实体的已知照片',
      'No Comments on Photo': '照片无评论',
      // Form
      Yes: '是',
      No: '否',
      ...
      File: '文件',
      'Photo Comment': '照片评论',
      'Select a file to upload and provide a comment to describe it.': '选择要上传的文件并提供评论来描述它。',
      // Menu
      Dashboard: '仪表盘',
      Visualization: '可视化',
      Workspaces: '工作区',
